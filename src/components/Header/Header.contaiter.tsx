...
import {AuthStateType, getAuthUserData, logOutAuthUser} from "../../Redux/auth-reducer";
...
export class HeaderContaiterAPI extends React.Component<AuthPropsType>{
    render(){
    return (
        <Header login={this.props.auth.login} isAuth={this.props.auth.isAuth} logOutAuthUser={this.props.logOutAuthUser}/>
    );
}
}
